...
export default function TiltedCard({
  ...
  function handleMouse(e: MouseEvent<HTMLElement>): void {
    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 rounded-[15px] object-cover shadow-2xl will-change-transform [transform:translateZ(0)]"
          style={{
            width: imageWidth,
            height: imageHeight,
          }}
