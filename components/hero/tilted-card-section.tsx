...
const MARKET_CARDS = [
  {
    imageSrc: "/ambiente-moderno.webp",
        ...
        {MARKET_CARDS.map((card) => (
          <article key={card.captionText} className="flex flex-col">
            ...
            <div className="mt-5 flex flex-1 flex-col px-1">
              ...
              <p className="text-foreground/65 mt-2 [font-family:var(--font-poppins)] text-[16px] leading-[1.45] tracking-tight">
                {card.text}
              </p>
              <div className="mt-auto pt-6">
                <OrbButton
                  ...
                  Icon={TrendingUp}
                  className="cursor-pointer [font-family:var(--font-poppins)]"
                  onClick={() =>
                    window.open(
